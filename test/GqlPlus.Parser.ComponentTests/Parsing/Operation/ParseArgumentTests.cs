...
public class ParseArgumentTests(Parser<IParserArgument, IGqlpArgument>.D parser)
{
  ...
  private readonly OneChecksParser<IParserArgument, IGqlpArgument> _checks = new(parser);
}
