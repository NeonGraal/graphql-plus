...
) : CheckObjectModel<IGqlpDualObject, DualDeclAst, IGqlpDualField, DualFieldAst, IGqlpDualAlternate, DualAlternateAst, IGqlpDualBase, IGqlpObjArg, TypeDualModel>(inputs, TypeKindModel.Dual)
  , IDualModelChecks
{
