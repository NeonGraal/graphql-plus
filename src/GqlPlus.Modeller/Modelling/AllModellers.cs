...
public static class AllModellers
{
  public static IServiceCollection AddModellers(this IServiceCollection services)
    => services
      ...
      // Object
      .AddModeller<IGqlpDualArgument, DualArgumentModel, DualArgumentModeller>()
      ...
      .AddModeller<IGqlpInputArgument, InputArgumentModel, InputArgumentModeller>()
      ...
      .AddModeller<IGqlpOutputArgument, OutputArgumentModel, OutputArgumentModeller>()
