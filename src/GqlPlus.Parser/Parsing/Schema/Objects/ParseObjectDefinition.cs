...
public class ParseObjectDefinition<TObjField>(
  Parser<IGqlpObjAlternate>.DA alternates,
  Parser<TObjField>.D parseField,
  Parser<IGqlpObjBase>.D parseBase
) : Parser<ObjectDefinition<TObjField>>.I
  where TObjField : IGqlpObjField
{
  private readonly Parser<IGqlpObjAlternate>.LA _alternates = alternates;
...
#pragma warning restore CA1062 // Validate arguments of public methods
    ...
    result.Fields = [.. fields];
    IResultArray<IGqlpObjAlternate> objectAlternates = _alternates.Parse(tokens, label);
