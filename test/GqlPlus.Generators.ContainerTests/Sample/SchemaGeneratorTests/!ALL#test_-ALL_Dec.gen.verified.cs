...
internal static class test__ALLDecoders
{
  internal static IDecoderRepositoryBuilder Addtest__ALLDecoders(this IDecoderRepositoryBuilder builder)
    => builder
      ...
      .AddDecoder<ItestAltAltDualObject>(r => new testAltAltDualDecoder(r))
      ...
      .AddDecoder<ItestObjDualAltDualInpObject>(r => new testObjDualAltDualInpDecoder(r))
      ...
      .AddDecoder<ItestAltAltModParamInpObject>(r => new testAltAltModParamInpDecoder(r))
      ...
      .AddDecoder<ItestAltCnstAltObjInpObject>(r => new testAltCnstAltObjInpDecoder(r))
      ...
      .AddDecoder<ItestAltCnstFieldDualDualObject>(r => new testAltCnstFieldDualDualDecoder(r))
      ...
      .AddDecoder<ItestAltCnstFieldObjDualObject>(r => new testAltCnstFieldObjDualDecoder(r))
      ...
      .AddDecoder<ItestAltCnstPrntDualGrndDualObject>(r => new testAltCnstPrntDualGrndDualDecoder(r))
      ...
      .AddDecoder<ItestAltCnstPrntDualPrntDualObject>(r => new testAltCnstPrntDualPrntDualDecoder(r))
      ...
      .AddDecoder<ItestAltCnstPrntDualPrntInpObject>(r => new testAltCnstPrntDualPrntInpDecoder(r))
      ...
      .AddDecoder<ItestAltCnstPrntObjPrntDualObject>(r => new testAltCnstPrntObjPrntDualDecoder(r))
      ...
      .AddDecoder<ItestAltCnstPrntObjPrntInpObject>(r => new testAltCnstPrntObjPrntInpDecoder(r))
      .AddDecoder<ItestFieldDualObject>(r => new testFieldDualDecoder(r))
      .AddDecoder<ItestFieldInpObject>(r => new testFieldInpDecoder(r))
      .AddDecoder<ItestFieldDescrDualObject>(r => new testFieldDescrDualDecoder(r))
      .AddDecoder<ItestFieldDescrInpObject>(r => new testFieldDescrInpDecoder(r))
      ...
      .AddDecoder<ItestFldFieldDualOutpObject>(r => new testFldFieldDualOutpDecoder(r))
      ...
      .AddDecoder<ItestFieldModEnumInpObject>(r => new testFieldModEnumInpDecoder(r))
      ...
      .AddDecoder<ItestFieldObjDualObject>(r => new testFieldObjDualDecoder(r))
      .AddDecoder<ItestFldFieldObjDualObject>(r => new testFldFieldObjDualDecoder(r))
      ...
      .AddDecoder<ItestFieldSmplInpObject>(r => new testFieldSmplInpDecoder(r))
      .AddDecoder<ItestFieldTypeDescrDualObject>(r => new testFieldTypeDescrDualDecoder(r))
      ...
      .AddDecoder<ItestFieldValueDescrDualObject>(r => new testFieldValueDescrDualDecoder(r))
      .AddDecoder<testEnumFieldValueDescrDual>(_ => new testEnumFieldValueDescrDualDecoder())
      .AddDecoder<ItestFieldValueDescrInpObject>(r => new testFieldValueDescrInpDecoder(r))
      ...
      .AddDecoder<ItestAltGnrcAltDualOutpObject>(r => new testAltGnrcAltDualOutpDecoder(r))
      .AddDecoder<ItestGnrcAltParamDualObject>(_ => new testGnrcAltParamDualDecoder())
      .AddDecoder<ItestAltGnrcAltParamDualObject>(r => new testAltGnrcAltParamDualDecoder(r))
      ...
      .AddDecoder<ItestGnrcFieldDualDualObject>(r => new testGnrcFieldDualDualDecoder(r))
      .AddDecoder<ItestAltGnrcFieldDualDualObject>(r => new testAltGnrcFieldDualDualDecoder(r))
      .AddDecoder<ItestGnrcFieldDualInpObject>(r => new testGnrcFieldDualInpDecoder(r))
      .AddDecoder<ItestAltGnrcFieldDualInpObject>(r => new testAltGnrcFieldDualInpDecoder(r))
      .AddDecoder<ItestAltGnrcFieldDualOutpObject>(r => new testAltGnrcFieldDualOutpDecoder(r))
      .AddDecoder<ItestGnrcFieldParamDualObject>(r => new testGnrcFieldParamDualDecoder(r))
      .AddDecoder<ItestAltGnrcFieldParamDualObject>(r => new testAltGnrcFieldParamDualDecoder(r))
      ...
      .AddDecoder<ItestAltGnrcPrntDualOutpObject>(r => new testAltGnrcPrntDualOutpDecoder(r))
      .AddDecoder<ItestGnrcPrntDualPrntDualObject>(_ => new testGnrcPrntDualPrntDualDecoder())
      .AddDecoder<ItestAltGnrcPrntDualPrntDualObject>(r => new testAltGnrcPrntDualPrntDualDecoder(r))
      ...
      .AddDecoder<ItestAltGnrcPrntDualPrntOutpObject>(r => new testAltGnrcPrntDualPrntOutpDecoder(r))
      ...
      .AddDecoder<ItestAltGnrcPrntParamDualObject>(r => new testAltGnrcPrntParamDualDecoder(r))
      ...
      .AddDecoder<ItestAltGnrcPrntParamPrntDualObject>(r => new testAltGnrcPrntParamPrntDualDecoder(r))
      ...
      .AddDecoder<ItestInpFieldDescrNmbrObject>(r => new testInpFieldDescrNmbrDecoder(r))
      .AddDecoder<ItestInpFieldEnumObject>(r => new testInpFieldEnumDecoder(r))
      ...
      .AddDecoder<ItestInpFieldNmbrObject>(r => new testInpFieldNmbrDecoder(r))
      .AddDecoder<ItestInpFieldNmbrDescrObject>(r => new testInpFieldNmbrDescrDecoder(r))
      ...
      .AddDecoder<ItestInOutpParamObject>(r => new testInOutpParamDecoder(r))
      ...
      .AddDecoder<ItestInOutpParamModParamObject>(r => new testInOutpParamModParamDecoder(r))
      ...
      .AddDecoder<ItestRefPrntAltInpObject>(r => new testRefPrntAltInpDecoder(r))
      .AddDecoder<ItestPrntDescrDualObject>(_ => new testPrntDescrDualDecoder())
      .AddDecoder<ItestRefPrntDescrDualObject>(r => new testRefPrntDescrDualDecoder(r))
      ...
      .AddDecoder<ItestRefPrntDualInpObject>(r => new testRefPrntDualInpDecoder(r))
      ...
      .AddDecoder<ItestDmnNmbrRange>(_ => new testDmnNmbrRangeDecoder())
      .AddDecoder<ItestDmnStrDescr>(_ => new testDmnStrDescrDecoder())
