  ...
  : TheoryData<string>
{
  public static readonly Dictionary<string, string> Source = new() {
    ...
    ["alts-mods-param"] = "object ObjAltModsParam<$mod> { | ObjModsParamAlt[$mod] } object ObjModsParamAlt { }",
    ...
    ["fields-mods-param"] = "object ObjFieldModsParam<$mod> { field: ObjFieldParamMods[$mod] } object ObjFieldParamMods { }",
    ["fields-object"] = "object FieldsObj { field: ObjField } object ObjField { }",
    ...
    ["output-params-mods-Domain"] = "output OutParamsDomain { field(OutParamDomain[OutDomainParam]): OutDomainParam } input OutParamDomain { } domain OutDomainParam { number 1 ~ 10 }",
    ["output-params-mods-param"] = "output OutParamsDomainParam<$mod> { field(OutParamDomainParam[$mod]): OutDomainsParam } input OutParamDomainParam { } domain OutDomainsParam { number 1 ~ 10 }",
