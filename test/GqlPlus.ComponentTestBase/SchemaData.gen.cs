  ...
  : TheoryData<string>
{
  public static readonly Dictionary<string, string> Source = new() {
    ...
    ["object-alts"] = "object ObjName { | ObjNameType } object ObjName { | ObjNameType } object ObjNameType { }",
    ["object-fields"] = "object ObjName { field: ObjNameFld } object ObjName { field: ObjNameFld } object ObjNameFld { }",
    ["object-fields-alias"] = "object ObjName { field [field1]: ObjNameFld } object ObjName { field [field2]: ObjNameFld } object ObjNameFld { }",
    ["object-params"] = "object ObjName<$test> { test: $test } object ObjName<$type> { type: $type }",
    ...
    ["output-fields-enum"] = "output FieldEnums { field = Boolean.true } output FieldEnums { field = true }",
    ["output-fields-enum-alias"] = "output FieldEnumAlias { field [field1] = Boolean.true } output FieldEnumAlias { field [field2] = true }",
    ["output-fields-params"] = "output FieldParams { field(FieldParam1): FieldParamsFld } output FieldParams { field(FieldParam2): FieldParamsFld } input FieldParam1 { } input FieldParam2 { } output FieldParamsFld { }",
...
{
  public static readonly Dictionary<string, string> Source = new() {
    ["alts"] = "object ObjName { | ObjNameAlt } object ObjNameAlt { alt: Number | String }",
    ["alts-dual"] = "object ObjName { | ObjDualName } dual ObjDualName { alt: Number | String }",
    ["alts-mods-Boolean"] = "object ObjName { | ObjNameAlt[^] } object ObjNameAlt { alt: Number | String }",
    ["alts-mods-param"] = "object ObjName<$mod> { | ObjNameAlt[$mod] } object ObjNameAlt { alt: Number | String }",
    ["alts-simple"] = "object ObjName { | String }",
    ["fields"] = "object ObjName { field: * }",
    ["fields-dual"] = "object ObjName { field: ObjNameFld } dual ObjNameFld { field: Number | String }",
    ["fields-mods-Enum"] = "object ObjName { field: *[ObjEnumName] } enum ObjEnumName { value }",
    ["fields-mods-param"] = "object ObjName<$mod> { field: ObjNameFld[$mod] } object ObjNameFld { field: Number | String }",
    ["fields-object"] = "object ObjName { field: ObjNameFld } object ObjNameFld { field: Number | String }",
    ["fields-simple"] = "object ObjName { field: Number }",
    ...
    ["parent-alts"] = "object ObjName { :ObjNameRef | Number } object ObjNameRef {  parent: Number | String }",
    ["parent-dual"] = "object ObjName { :ObjNameRef } dual ObjNameRef { parent: Number | String }",
    ["parent-fields"] = "object ObjName { :ObjNameRef field: Number } object ObjNameRef { parent: Number | String }",
    ["parent-params-diff"] = "object ObjName<$a> { :ObjNameRef<$a> field: $a } object ObjNameRef<$b> { | $b }",
    ["parent-params-same"] = "object ObjName<$a> { :ObjNameRef<$a> field: $a } object ObjNameRef<$a> { | $a }",
  };
