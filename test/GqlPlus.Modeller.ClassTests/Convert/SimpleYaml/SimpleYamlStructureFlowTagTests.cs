  ...
  : StructureConvertToTestsBase(SimpleYamlTestHelpers.Converters)
{
  ...
  public void ConvertTo_MapOfLists_Specific()
    => ConvertTo_MapOfLists([
      new("iRG46", ["D_", "ThcnCuLI595_v_"]),
      new("Zk", ["FBqi_", "f312n4ZKO2gn____W414_yv7jp2P6DQFh", "MD8Uc_0", "Y6__p8d_67H4_OXgFKG_2U3455d_Vs_0_6G_xFo", "Z__bfH_9ivj"]),
      new("br__woN",["diY4N_9M", "s__0_77f_D8__"])]);

  [Fact]
  public void ConvertTo_MapOfMaps_Specific()
    => ConvertTo_MapOfMaps([
      new("iRG46", [new("Lu_C", "YB"), new("I", "p_P0C_F"), new("VUR_mm3Z7", "u")]),
      new("Zk", [new("eb_a9WT_m", "Xw3M5n"), new("hb__Zd", "dO033zOS9sC6___GQf__t_de__Mw_y2__T_l7_T_M6___Xt_t__J"), new("e__6w2F0GwH_Q_sD_", "M_Rm")]),
      new("br__woN",[new("G", "Cd"), new("u12S9QmHS_WY_9_dRZ8Q77t7", "H94UXY0"), new("W", "Uw_HR_e4k")])]);
  ...
  protected override string[] Expected_MapOfLists(MapPair<string[]>[] value)
    => value.FlowMap(v => v!.FlowList("!value ", "!list"), "!map", indent: "  ");
