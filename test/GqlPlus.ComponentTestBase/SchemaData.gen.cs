  ...
  : TheoryData<string>
{
  public static readonly Dictionary<string, string> Source = new() {
    ...
    ["output-params-mod-undef"] = "output Test { field(Param[Domain]): Test } input Param { }",
    ["output-params-mod-undef-param"] = "output Test { field(Param[$a]): Test } input Param { }",
    ["output-params-mod-wrong"] = "output Test { field(Param[Test]): Test } input Param { }",
  ...
  : TheoryData<string>
{
  public static readonly Dictionary<string, string> Source = new() {
    ...
    ["output-params-mod-Domain"] = "output OutParamsDomain { field(OutParamDomain[OutDomainParam]): OutDomainParam } input OutParamDomain { param: Number | String } domain OutDomainParam { number 1 ~ 10 }",
    ["output-params-mod-param"] = "output OutParamsDomainParam<$mod> { field(OutParamDomainParam[$mod]): OutDomainsParam } input OutParamDomainParam { param: Number | String } domain OutDomainsParam { number 1 ~ 10 }",
