...
internal static class test_constraint_alt_obj_InputEncoders
{
  internal static IEncoderRepositoryBuilder Addtest_constraint_alt_obj_InputEncoders(this IEncoderRepositoryBuilder builder)
    => builder
