  ...
  : EncoderClassTestBase<OpSelectionModel>
{
  public OpSelectionEncoderTests()
    => Encoder = new OpSelectionEncoder();

  protected override IEncoder<OpSelectionModel> Encoder { get; }

  [Fact]
  public void Encode_WithFieldSelectionModel_ReturnsStructured()
  {
  ...
  [Fact]
  public void Encode_WithInlineSelectionModel_ReturnsStructured()
  {
    EncodeAndCheck(new OpInlineSelectionModel(null, string.Empty), [
        "=[_OpInlineSelection]",
      ]);
  }

  [Fact]
  public void Encode_WithSpreadSelectionModel_ReturnsStructured()
  {
