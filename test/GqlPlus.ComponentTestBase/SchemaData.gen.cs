  ...
  : TheoryData<string>
{
  public static readonly Dictionary<string, string> Source = new() {
    ...
    ["field-diff-mods"] = "object Test { field: Test } object Test { field: Test[] }",
    ["field-diff-type"] = "object Test { field: Test } object Test { field: Test1 } object Test1 { }",
    ["field-mods-undef"] = "object Test { field: Test[Random] }",
    ["field-mods-undef-param"] = "object Test { field: Test[$a] }",
    ["field-mods-wrong"] = "object Test { field: Test[Test] }",
    ...
    ["parent-field-mods"] = "object Test { :Parent } object Test { field: Test } object Parent { field: Test[] }",
    ["parent-field-mods-more"] = "object Test { :Recurse field: Test } object Recurse { :More } object More { :Parent } object Parent { field: Test[] }",
    ["parent-field-mods-recurse"] = "object Test { :Recurse field: Test } object Recurse { :Parent } object Parent { field: Test[] }",
  ...
  : TheoryData<string>
{
  public static readonly Dictionary<string, string> Source = new() {
    ...
    ["output-field-params"] = "output FieldParams { field(FieldParam1): FieldParamsFld } output FieldParams { field(FieldParam2): FieldParamsFld } input FieldParam1 { } input FieldParam2 { } output FieldParamsFld { }",
  ...
  : TheoryData<string>
{
  public static readonly Dictionary<string, string> Source = new() {
    ...
    ["field-mods-Enum"] = "object ObjName { field: *[ObjEnumName] } enum ObjEnumName { value }",
    ["field-mods-param"] = "object ObjName<$mod> { field: ObjNameFld[$mod] } object ObjNameFld { field: Number | String }",
