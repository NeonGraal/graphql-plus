...
internal static class test_object_parent_InputEncoders
{
  internal static IEncoderRepositoryBuilder Addtest_object_parent_InputEncoders(this IEncoderRepositoryBuilder builder)
    => builder
