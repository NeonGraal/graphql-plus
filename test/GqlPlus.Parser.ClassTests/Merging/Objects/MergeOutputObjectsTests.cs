...
public class MergeOutputObjectsTests
  : TestObjects<OutputDeclAst, OutputFieldAst, IGqlpOutputBase>
{
  ...
  internal override AstObjectsMerger<OutputDeclAst, OutputFieldAst, IGqlpOutputBase> MergerObject => _merger;
