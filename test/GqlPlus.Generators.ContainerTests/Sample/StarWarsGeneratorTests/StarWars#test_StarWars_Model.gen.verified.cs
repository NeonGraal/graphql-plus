...
public class testQueryObject
  ...
  , ItestQueryObject
{
  public ItestCharacter Hero { get; set; }
  public ItestCharacter? Call_Hero(testEpisode? parameter)
    => null;
  public ItestHuman Human { get; set; }
  public ItestHuman? Call_Human(string parameter)
    => null;
  public ItestDroid Droid { get; set; }
  public ItestDroid? Call_Droid(ItestId parameter)
    => null;
  public ICollection<ItestCharacter> Characters { get; set; }
  public ICollection<ItestCharacter>? Call_Characters(ICollection<ItestId>? parameter)
    => null;

  public testQueryObject
    ( ItestCharacter phero
    , ItestHuman phuman
    , ItestDroid pdroid
    , ICollection<ItestCharacter> pcharacters
    )
  {
    Hero = phero;
    Human = phuman;
