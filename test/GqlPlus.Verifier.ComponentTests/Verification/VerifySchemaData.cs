  ...
  : TheoryData<string>
{
  public static readonly Dictionary<string, string> Source = new() {
    ...
    ["output-params-mods-Domain"] = "output OutParamsDomain { field(OutParamDomain[OutDomainParam]): OutParamsDomain } input OutParamDomain { } domain OutDomainParam { number 1 ~ 10 }",
